...
//     // Show the current guide and start the process of shrinking and moving it
...
//         // Set x to 0 (left side of the screen) and y to a value for bottom position
...
//         {
//             // Smoothly move the guide image from start to target position
